...
/// Trend direction
public enum MarketSentimentType: String, Codable {
...
public typealias MarketSentiment = MarketSentimentType

/// Consolidated sentiment analysis model
public struct SentimentAnalysis: Codable {
    ...
    public let marketSentiment: MarketSentimentType?
    ...
    public init(
        ...
        marketSentiment: MarketSentimentType? = nil,
        keywords: [String]? = nil,
        sources: [String]? = nil
    ) {
...
/// Sentiment type for analysis results
public enum SentimentType: String, Codable, CaseIterable {
...
public struct SentimentResult: Codable {
    ...
    public init(sentiment: SentimentType, score: Double, description: String) {
